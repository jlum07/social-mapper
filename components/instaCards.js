...
class InstaCardsScreen extends React.Component {
  ...
  async componentDidMount() {
    ...
    let rawInsta = await this.getInstagrams(this.props.navigation.state.params.location);
